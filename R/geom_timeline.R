#' Visualize the timeline of earthquakes occurring in different countries
#'
...
#'
#' @details The data to be used with this geom can be downloaded from NOAA site,
...
#' data %>%
#' dplyr::filter(COUNTRY == c("ISRAEL","USA") & lubridate::year(DATE) >= 2012) %>%
